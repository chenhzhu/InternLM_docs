...
streamlit run /root/InternLM/Tutorial/tools/xtuner_streamlit_demo.py --server.port 8501
```
...
在微调之前，大模型回答如下:
![streamlit](./images/9_before_finetune.png)
...
![列出配置文件](./images/7_list_xtuner_conf.png)
...
![训练微调](./images/10_train_finetune.png)
...
> 
![模式转换](./images/11_format_change_hf.png)
...
![模型合并](./images/12_finetune_merge.png)
...
```bash
ssh -CNg -L 8501:127.0.0.1:8501 root@ssh.intern-ai.org.cn -p 45523
```

最后，通过浏览器访问：http://127.0.0.1:8501 来进行对话了。

![](./images/13_after_finetune.png)
